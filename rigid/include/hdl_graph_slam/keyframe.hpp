...
public:
  ...
  int index; // index of arrival in the system of the keyframe
  ...
  bool buildings_check; // true if the keyframe has already been checked for the presence of buildings
  pcl::PointCloud<pcl::PointXYZ>::Ptr odomCloud;   // filtered cloud used to build the map
};
