...
public:
  ...
  void load(ParamServer& params) {
    ...
    b_cut = params.template param<double>("gicp_max_correspondance_distance", 5.0);
  }
  ...
  /**
   * @brief compute the fitness score for buildings and also retrieve the used correspondences
   */
  ...
  /**
   * @brief compute the fitness score for buildings
   */
