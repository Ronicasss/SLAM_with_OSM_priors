          ...
          if(new_buildings.size() > 0) { 
            ...
            for(auto it2 = bnodes.begin(); it2 != bnodes.end(); it2++)
            {
              ...
              if(private_nh.param<bool>("b_use_const_inf_matrix", true)) {
                ...
                //dynamic im
                Eigen::MatrixXd information_matrix_6 = inf_calclator->calc_information_matrix_buildings(temp_cloud_building, odomCloud, isometry2dto3d(t_scan_buildings_iso));

                im(0, 0) = information_matrix_6(0,0);
                im(1, 1) = information_matrix_6(1,1);
                im(2, 2) = information_matrix_6(5,5);
              }
